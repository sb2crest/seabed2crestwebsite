            ...
            <>
                <header class={scrolled ? "main-header fixed-header" : "main-header"}>
                        ...
                        <div class="auto-container">
                            <div class="inner">
                                <div class="top-left">
                                    ...
                                    <div class="logo-box">
                                        <div class="logo"><Link to={'/#'}><img src={require('../../assets/images/seabed2crest-logo.png')} alt="" width={'110px'}/></Link></div>
                                    </div>
                                </div>
                                ...
                                <div class="top-middile">
                                    ...
                                    <div class="contact-info">
                                        ...
                                        <div class="single-info">
                                            ...
                                            <h4><Link to={'mailto:info@seabed2crest.com'}>info@seabed2crest.com</Link></h4>
                                        </div>
                                    </div>
                                </div>

                                <div class="top-right">
                                    <Link to={'/contact'} class="theme-btn btn-style-two"><span class="btn-title">Contact Us</span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class={scrolled ? "sticky-header animated slideInDown" : "sticky-header"}>
                        <div class="auto-container clearfix">
                            ...
                            <div class="logo pull-left">
                                <Link to={'/#'} title=""><img src={require('../../assets/images/seabed2crest-logo.png')} alt="" title="" width={'60px'}/></Link>
                            </div>
                    ...
                    <div class="mobile-menu">
                        ...
                        <nav class="menu-box">
                            <div class="nav-logo"><Link to={'/#'}><img src="assets/images/seabed2crest-logo.png" alt="" title="" width={'60px'} /></Link></div>
