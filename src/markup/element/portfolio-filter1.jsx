...
const PortfolioFilter1 = props => {
  ...
  <li
    className={`filter ${state.filterKey === "NONE" ? "active" : ""}`}
    onClick={() => setState({ ...state, filterKey: "NONE" })}
  >
    <span>Financial</span>
  </li>
  <li
    className={`filter ${state.filterKey === "BANKING" ? "active" : ""}`}
    onClick={() => setState({ ...state, filterKey: "BANKING" })}
  >
    <span>Banking</span>
  </li>
  {/* <li
    className={`filter ${state.filterKey === "INSURANCE" ? "active" : ""}`}
    onClick={() => setState({ ...state, filterKey: "INSURANCE" })}
  >
    <span>Insurance</span>
  </li> */}
  <li
    className={`filter ${state.filterKey === "FAMILY" ? "active" : ""}`}
    onClick={() => setState({ ...state, filterKey: "FAMILY" })}
  >
    <span>Family</span>
  </li>
  <li
    className={`filter ${state.filterKey === "BUSINESS" ? "active" : ""}`}
    onClick={() => setState({ ...state, filterKey: "BUSINESS" })}
  >
    <span>Business</span>
  </li>
</ul>
